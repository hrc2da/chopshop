          ...
          <Table>
            <TableBody>
               <TableRow>
                ...
                <TableCell width = '30%'>The larger the wheel radius, the farther the car goes per revolution.</TableCell>
               </TableRow>
               <TableRow>
               ...
               <TableRow>
                ...
                <TableCell>
                  <Tooltip title={config.steering_scalar} placement="left" open={true}>
                    <Slider
                      id={STEERING_SCALAR}
                      max={2}
                      min={0}
               ...
               <TableRow>
                ...
                <TableCell>
                  <Tooltip title={config.rear_steering_scalar} placement="left" open={true}>
                    <Slider
