            ...
            <Grid container spacing={0}>
              <Grid item xs={4}>
                <Button
                  ...
                  disabled={this.props.loading && !this.props.submitFormOpen}
                  variant="contained"
                  color="green"
              ...
              <Grid item xs={4}>
                <Button
                  ...
                  variant="contained"
                  color="secondary"
                  onClick={this.props.handlePreSubmit}
                >
                  Submit my Design!
                </Button>
              </Grid>
                    ...
                    >
                      <FormGroup>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              name={FRICTION_LIM}
                              checked={
                                this.props.selectedFeatures[FRICTION_LIM]
                              }
                              onChange={this.props.handleChangeFeatures}
                            />
                          }
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              name={BRAKE_SCALAR}
                              checked={
                                this.props.selectedFeatures[BRAKE_SCALAR]
                              }
                              onChange={this.props.handleChangeFeatures}
                            />
                          }
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              name={STEERING_SCALAR}
                              checked={
                                this.props.selectedFeatures[STEERING_SCALAR]
                              }
                              onChange={this.props.handleChangeFeatures}
                            />
                          }
