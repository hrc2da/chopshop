      ...
      <Table>
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell>
              Steering Sensitivity: {config.steering_scalar}
            </TableCell>
            <TableCell>
              Estimated Cost: ${Math.floor(calculateCarCost(config))}
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>
              Tire Tread: {Math.floor(config.friction_lim / 1e2)}
            </TableCell>
            <TableCell>
              Rear Steering Power: {config.rear_steering_scalar}
            </TableCell>
            <TableCell>
              Car Weight: {Math.floor(calculateCarWeight(config))} lb
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell>
              Horsepower: {Math.floor(config.eng_power / 1e3)}
            </TableCell>
